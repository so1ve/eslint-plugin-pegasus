...
/**
 * Validates a rule's severity and returns the severity value. Throws an error
 ...
 *   If null or undefined, no source is prepended to the message.
 ...
 * @param source The name of the configuration source to report in the event of
 *   an error.
 */
 ...
 */
const formatErrors = (errors: AjvErrorObject[]): string =>
	errors
		.map((error) => {
