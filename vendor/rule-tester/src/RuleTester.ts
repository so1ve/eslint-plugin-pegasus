...
export class RuleTester extends TestFramework {
    ...
    */
	 ...
	 *
	 * @throws {Error} If an invalid schema. Use @private instead of #private to
	...
	/**
	 * Check if the template is valid or not all valid cases go through this
	 */
	#testValidTemplate<
		TMessageIds extends string,
		TOptions extends readonly unknown[],
...
/**
 * Asserts that the message matches its expected value. If the expected value is
 * a regular expression, it is checked against the actual value.
 */
