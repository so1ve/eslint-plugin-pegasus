...
export interface SuggestionOutput<TMessageIds extends string> {
	...
	/**
	 * NOTE: Suggestions will be applied as a stand-alone change, without
	 * triggering multi-pass fixes. Each individual error has its own suggestion,
	 * so you have to show the correct, _isolated_ output for each suggestion.
	 */
...
> extends ValidTestCase<TOptions> {
	...
	/**
	 * The expected code after autofixes are applied. If set to `null`, the test
	 * runner will assert that no autofix is suggested.
	 */
